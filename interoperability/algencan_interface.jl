...
function run_algencan()
  evalf_ptr = @cfunction(ProblemDefinition.evalf!, Nothing, (Ref{Int64},Ptr{Float64},Ref{Float64},Ref{Int64}))
  evalg_ptr = @cfunction(ProblemDefinition.evalg!, Nothing, (Ref{Int64},Ptr{Float64},Ptr{Float64},Ref{Int64},Ref{MyDataPtr}))
  evalc_ptr = @cfunction(ProblemDefinition.evalc!, Nothing, (
    Ref{Int64},Ptr{Float64},Ref{Int64},Ref{Int64},Ptr{Float64},Ref{Int64},Ref{MyDataPtr}
  ))
  ...
  @ccall lib_path.__algencanma_MOD_init(
    ...
    n::Ref{Int64}, lind::Ptr{Vector{Int32}}, lbnd::Ptr{Float64},
